        ...
        <div class="container header-container">
            ...
            <nav id="mainNav">
                <ul>
                    ...
                    <li class="dropdown">
                        <a href="#"><i class="fas fa-th-large"></em> Categories <i class="fas fa-chevron-down"></em></a>
                        <div class="dropdown-content">
                            <a href="#"><i class="fas fa-mobile-alt"></em> Smartphones</a>
                            <a href="#"><i class="fas fa-laptop"></em> Laptops</a>
                            <a href="#"><i class="fas fa-tshirt"></em> Clothing</a>
                            <a href="#"><i class="fas fa-headphones"></em> Gadgets</a>
                            <a href="#"><i class="fas fa-shoe-prints"></em> Footwear</a>
                            <a href="#"><i class="fas fa-watch"></em> Accessories</a>
                        </div>
                    </li>
                    <li><a href="#"><i class="fas fa-fire"></em> Trending</a></li>
                    <li><a href="#"><i class="fas fa-percent"></em> Deals</a></li>
                    <li><a href="#"><i class="fas fa-info-circle"></em> About</a></li>
                    <li><a href="#"><i class="fas fa-envelope"></em> Contact</a></li>
                </ul>
            </nav>
            
            <div class="search-bar">
                <input type="text" placeholder="Search products...">
                <button type="submit"><i class="fas fa-search"></em></button>
            </div>
            
            <div class="header-icons">
                <a href="#"><i class="far fa-user"></em></a>
                <a href="#"><i class="far fa-heart"></em></a>
                <a href="#"><i class="fas fa-shopping-cart"></em><span class="cart-count">3</span></a>
                <button class="mobile-menu-btn" id="mobileMenuBtn"><i class="fas fa-bars"></em></button>
            </div>
        </div>
    </header>
    ...
    <section class="container">
        ...
        <div class="categories">
            <div class="category-card">
                <div class="category-icon"><i class="fas fa-mobile-alt"></em></div>
                <h3>Smartphones</h3>
                <p>Latest models from top brands</p>
            </div>
            <div class="category-card">
                <div class="category-icon"><i class="fas fa-laptop"></em></div>
                <h3>Laptops</h3>
                <p>Powerful machines for work & play</p>
            </div>
            <div class="category-card">
                <div class="category-icon"><i class="fas fa-tshirt"></em></div>
                <h3>Clothing</h3>
                <p>Trendy outfits for every occasion</p>
            </div>
            <div class="category-card">
                <div class="category-icon"><i class="fas fa-headphones"></em></div>
                <h3>Gadgets</h3>
                <p>Smart devices for modern life</p>
            </div>
            <div class="category-card">
                <div class="category-icon"><i class="fas fa-shoe-prints"></em></div>
                <h3>Footwear</h3>
                <p>Comfortable & stylish shoes</p>
            </div>
            <div class="category-card">
                <div class="category-icon"><i class="fas fa-watch"></em></div>
                <h3>Accessories</h3>
            ...
            <div class="footer-container">
                <div class="footer-col">
                    ...
                    <div class="social-links">
                        <a href="#"><i class="fab fa-facebook-f"></em></a>
                        <a href="#"><i class="fab fa-twitter"></em></a>
                        <a href="#"><i class="fab fa-instagram"></em></a>
                        <a href="#"><i class="fab fa-youtube"></em></a>
                    </div>
                </div>
                <div class="footer-col">
                    <h3>Shop</h3>
